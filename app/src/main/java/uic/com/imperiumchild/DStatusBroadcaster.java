...
public class DStatusBroadcaster extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try{
            ...
            try {
                InputStream inputStream = context.openFileInput("test5.txt");
    ...
    private void start_lockscreen(Context context) {
        Intent mIntent = new Intent(context, DStatusLockScreen.class);
