...
public class WStatusLockScreen extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        try{
            ...
            if(active) {
                ...
                makeFullScreen();
                startService(new Intent(WStatusLockScreen.this, CheckerService.class));
                HomeKeyLocker homeKeyLocker = new HomeKeyLocker();
                homeKeyLocker.lock(WStatusLockScreen.this);
            ...
            switch(requestCode) {
                case RESULT_ENABLE :
                    if (resultCode == Activity.RESULT_OK) {
                        ...
                        devicePolicyManager.lockNow();
                        Toast.makeText(WStatusLockScreen.this, "Admin Device Features enabled!", Toast.LENGTH_SHORT).show();


                    } else {

                        Toast.makeText(WStatusLockScreen.this, "Problem to enable the Admin Device features", Toast.LENGTH_SHORT).show();
                        ...
                        if (useremailz != null) {
                            ...
                            getusers.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    String usertasksz = dataSnapshot.child("Users").child(useremail).child("Children").child(splitss[0]).child("WeeklyTasks").child("To-Do").getValue(String.class);
                                    if(usertasksz!=null){
